...
--     follower_count          INT(5)              DEFAULT 0,
...
--   CONSTRAINT Review_Images_PK PRIMARY KEY(product_review_id, review_img_id),
--   CONSTRAINT Review_Images_FK FOREIGN KEY(product_review_id)
-- );
