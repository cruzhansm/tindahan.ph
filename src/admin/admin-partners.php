...
<body class="bg-primary">
  <div class="modal fade" id="pendingPartnerProfile" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable shop-modal-dialog partner-modal-dialog">
      <div class="modal-content partner-modal-content">
        <div class="shop-modal-header partner-modal-header" data-bs-dismiss="modal" onclick="dismissModal(pendingPartnerProfile)">
