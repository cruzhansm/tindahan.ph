...
<body class="bg-primary">
  ...
  <!-- MODAL CONTENT ENDS -->
  <div class="modal fade" id="productRemove" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog remove-product">
      <div class="modal-content remove-product">
        ...
        <div class="modal-footer remove-product">
          ...
          <button id="cancel" type="button" class="btn modal-cancel-btn remove-product" data-bs-dismiss="modal" onclick="dismissModal(productRemove)">
            Cancel
          </button>
        </div>
      </div>
        ...
        <div class="container-cart">
          ...
          <div class="checkout">
            <div class="container-checkout">
              ...
              <button class="btn btn-primary cart-checkout-btn" onclick="attemptCheckout()">
                Check out
              </button>
            </div>
          </div>
