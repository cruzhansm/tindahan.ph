...
<head>
  ...
  <link rel="stylesheet" href="../../css/common/help-center/help-center-modal.css" />
...
<body class="bg-primary">
  ...
  <!-- MODAL CONTENT ENDS -->
  <div class="modal fade" id="orderCancel" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
  ...
  <div class="modal" id="productReview" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
        ...
        <form class="form-modal">
          <div class="modal-body help-center">
            <div class="purchase-product-rating">
              ...
              <select name="prating" id="productRatingSelect" class="form-select">
            ...
            <div class="for-validation">
              <div class="form-textarea">
                <textarea id="productReviewMsg" cols="30" rows="10" maxlength="250" class="form-control no-success not-required" placeholder="Type your message here"></textarea>
          ...
          <div class="container-orders-filter">
            ...
            <form class="orders-filters">
              <div class="order-filter-type">
                <input id="all" type="radio" name="filter" class="form-check-input" checked />
                <label for="all" class="form-check-label">All</label>
              </div>
              <div class="order-filter-type">
                <input id="confirmation" type="radio" name="filter" class="form-check-input" />
                <label for="confirmation" class="form-check-label">To Confirm</label>
              </div>
              <div class="order-filter-type">
                <input id="processing" type="radio" name="filter" class="form-check-input" />
                <label for="processing" class="form-check-label">To Ship</label>
              </div>
              <div class="order-filter-type">
                <input id="transit" type="radio" name="filter" class="form-check-input" />
                <label for="transit" class="form-check-label">To Receive</label>
              </div>
              <div class="order-filter-type">
                <input id="delivered" type="radio" name="filter" class="form-check-input" />
                <label for="delivered" class="form-check-label">Delivered</label>
              </div>
              <div class="order-filter-type">
                <input id="cancelled" type="radio" name="filter" class="form-check-input" />
