...
export function initializeInfoSettings() {
  $.ajax({
    ...
    success: (data) => {
      ...
      data.city == null || data.city == ""  ? city.placeholder="Not yet set" : city.value=data.city;
      data.barangay == null || data.barangay == "" ? barangay.placeholder="Not yet set" : barangay.value=data.barangay;
      data.street == null || data.street == ""  ? street.placeholder="Not yet set" : street.value=data.street;
      data.zipcode == null || data.zipcode == ""  ? zipcode.placeholder="Not yet set" : zipcode.value=data.zipcode;
      data.landmark == null || data.landmark == "" ? landmark.placeholder="Not yet set" : landmark.value=data.landmark;
      data.phone == null || data.phone == 0 ? phone.placeholder="Not yet set" : phone.value=data.phone;
